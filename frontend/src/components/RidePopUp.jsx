          ...
          <div className='flex justify-between items-center flex-col bg-white p-3 rounded-lg shadow-md'>
            <div className='w-full p-3'>
             ...
             <div className='flex items-center justify-center w-full gap-2'>
               <button onClick={()=>{
                 props.setRidePopUpPanel(false)
               }} className='w-1/2 bg-gray-400 text-gray-700 font-semibold p-2 rounded-lg'>Ignore</button>
               <button onClick={()=>{
                    props.setRidePopUpPanel(false)
                    props.setConfirmRidePopupPanel(true)

              }} className='w-1/2 bg-yellow-500 text-black font-semibold p-2 rounded-lg'>Accept</button>
             </div>
          </div>
    </div>
  )
